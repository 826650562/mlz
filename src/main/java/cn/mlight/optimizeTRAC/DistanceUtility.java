...
public class DistanceUtility {
	...
	public static double GetSpatialDistance(TrajPoint Point1, TrajPoint Point2) {
		return dist_m(Point1.y, Point1.x, Point2.y, Point2.x);
	}

/*	public static double GetSpatialDistance(SamplePoint Point1,
			SamplePoint Point2) {
		return dist_m(Point1.y, Point1.x, Point2.y, Point2.x);
	}*/

	/*public static double GetSpatialDistance(TrajPoint Point1, SamplePoint Point2) {
		return dist_m(Point1.y, Point1.x, Point2.y, Point2.x);
	}*/

	public static double GetSpatialDistance(double x1, double y1, double x2,
			double y2) {
	...
	public static double GetSpeed(TrajPoint Point1, TrajPoint Point2) {
		double d = dist_m(Point1.y, Point1.x, Point2.y, Point2.x);
		// long t = Point1.t.numSecondsFrom(Point2.t);

		long ts = Point1.t.toInstant().getMillis()
				- Point2.t.toInstant().getMillis();
		double t = ts / 1000.0;
		if (t < 0)
			t = -t;
...
/*	public static double GetSpeed(SamplePoint Point1, SamplePoint Point2) {
	...
	public static void main(String[] args) {
		double[] a = new double[] { 121.345373, 31.306466 }, b = new double[] {
				121.3114, 31.272142 };

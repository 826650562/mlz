...
/**
 * Description: ArrayBlockingQueueWithShutdown
 * Author: chenzhi
 * Update: chenzhi(2015-09-02 14:45)
 */
...
/**
 * Like ArrayBlockingQueue but with additional {@link #shutdown()} and
 * {@link #start} methods. Will throw {@link InterruptedException} if Queue has
 * been shutdown on {@link #take()} and {@link #poll(long, TimeUnit)}.
 * <p>
 * Based on ArrayBlockingQueue of OpenJDK by Doug Lea (who released
 * ArrayBlockingQueue as public domain).
 *
 * @param <E>
...
public class ArrayBlockingQueueWithShutdown<E> extends AbstractQueue<E> implements BlockingQueue<E> {
	...
	/**
	 * Shutdown the Queue. Will method currently waiting for a not full/empty
	 * condition will unblock (and usually throw a InterruptedException).
	 */
	...
	/**
	 * Start the queue. Newly created instances will be started automatically,
	 * thus this only needs to be called after {@link #shutdown()}.
	 */
	public void start() {
		lock.lock();
		try {
	 ...
	 * </ol>
	 * So you have to check which is the case, e.g. by calling
	 * {@link #isShutdown()}.
	 *
	 * @param e
	 *            the element to add.

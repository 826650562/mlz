...
public class ViKeyJavaObj {
	...
	private native int ViKeyRandom(short Index, short[] pwRandom1, short[] pwRandom2, short[] pwRandom3,
			short[] pwRandom4);
	...
	public native int Vikey3DesEncrypt(short Index, short length, byte[] pText, byte[] pResult);
	...
	public int ResetPassword(short Index, byte[] NewUserPassword, byte[] NewAdminPassword) {
	...
	public int Random(short Index, short[] pwRandom1, short[] pwRandom2, short[] pwRandom3, short[] pwRandom4) {
	...
	public int SetModule(short Index, short wModuleIndex, short wValue, short wMode) {
		return ViKeySetModule(Index, wModuleIndex, wValue, wMode);
	}

	public int CheckModule(short Index, short wModuleIndex, short[] IsZero, short[] CanDecrase) {

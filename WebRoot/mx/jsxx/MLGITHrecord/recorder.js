var Recorder= {
  ...
  upload: function(options){
    ...
    this.clearBindings("uploadFail");
    this.bind("uploadFail", function(responseText){
      options.error(Recorder._externalInterfaceDecode(responseText));
    });
  ...
  _defaultOnShowFlash: function(e){

...
(function(w){
    ...
    legend.prototype = {
        init: function(){
            ...
            element.style.cssText = "border-radius:5px;position:absolute;"+positionCss+"font-family:Helvetica; width:256px;z-index:999; background:rgba(255,255,255,1);padding:10px;border:1px solid black;margin:0;";
    ...
    heatmap.prototype = {
        ...
        init: function(){
                ...
                me.resize();
                canvas.style.cssText = acanvas.style.cssText = "position:absolute;top:0;left:0;z-index:999;";
                if(!me.get("visible"))
